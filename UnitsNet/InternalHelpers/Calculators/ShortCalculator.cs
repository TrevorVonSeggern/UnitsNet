namespace UnitsNet.InternalHelpers.Calculators
{
    ...
    public struct ShortCalculator : INumberCalculator<numberType>
    {
        ...
        public numberType Modulo(numberType a, numberType b) => (numberType)(a % b);
        ...
        public numberType ConvertToNumber(decimal v) => Decimal.ToInt16(v);
        ...
        public numberType ConvertToNumber(int v) => (numberType)v;
        ...
        public short ConvertToShort(numberType v) => v;

        public numberType Floor(numberType a) => a;
        public numberType Negate(numberType a) => (short)-(int)a;
